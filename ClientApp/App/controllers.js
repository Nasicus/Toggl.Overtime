(function(app) {
    ...
    app.controller("togglRootController", ["$scope", "webApi", "$filter", "appConfig", function($scope, webApi, $filter, appConfig) {
        ...
        $scope.calculateOvertime = function() {
            ...
            webApi.getData($scope.apiToken, $scope.regularWorkingHours, formattedStartDate, formattedEndDate, successCallback, errorCallback);
        };
        ...
        function errorCallback(status, errorMessage) {
            $scope.hasError = true;
